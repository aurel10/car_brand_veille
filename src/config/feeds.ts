...
export const SOURCE_TIERS: Record<string, number> = {
  ...
  'Chosun Ilbo': 2,
  'OpenAI News': 3,
  // Automotive & Industry (Direct Feeds)
  'Automotive News Europe': 3,
  'Automotive News': 3,
  'Autocar': 3,
  'Motor1': 3,
  'WardsAuto': 3,
  'Seeking Alpha Renault': 3,
  'Handelsblatt': 2,
  'Just Auto': 3,
  'Romania Insider': 3,
  'Economica.net': 3,
...
const RENAULT_FEEDS: Record<string, Feed[]> = {
  alerts: [
    ...
    { name: 'Automotive News Europe', url: rss('https://europe.autonews.com/rss') },
    { name: 'Automotive News', url: rss('https://www.autonews.com/rss') },
    { name: 'Autocar', url: rss('https://www.autocar.co.uk/rss') },
    { name: 'Motor1', url: rss('https://www.motor1.com/rss/news/all/') },
    { name: 'WardsAuto', url: rss('https://www.wardsauto.com/rss') },
    { name: 'Seeking Alpha Renault', url: rss('https://seekingalpha.com/api/sa/combined/RNLSY.xml') },
    { name: 'Handelsblatt', url: rss('https://www.handelsblatt.com/contentexport/feed/wirtschaft/'), lang: 'de' },
  ],
  operations: [
    { name: "L'Usine Nouvelle (Proxy)", url: rss('https://news.google.com/rss/search?q=site:usinenouvelle.com+automobile+when:3d&hl=fr&gl=FR&ceid=FR:fr'), lang: 'fr' },
    { name: 'Just Auto', url: rss('https://www.just-auto.com/feed/') },
    { name: 'Romania Insider', url: rss('https://www.romania-insider.com/feed') },
    { name: 'Economica.net', url: rss('https://www.economica.net/rss'), lang: 'ro' },
    { name: 'Daily Sabah', url: rss('https://www.dailysabah.com/rssFeed/business') },
    { name: 'Hurriyet Daily News', url: rss('https://www.hurriyetdailynews.com/rss/news') },
    { name: 'Le360', url: rss('https://fr.le360.ma/arc/outboundfeeds/rss/?outputType=xml'), lang: 'fr' },
    { name: 'TelQuel', url: rss('https://telquel.ma/feed'), lang: 'fr' },
    { name: 'Morocco World News', url: rss('https://www.moroccoworldnews.com/feed') },
    { name: 'Korea Herald', url: rss('https://www.koreaherald.com/rss/kh_Business') },
    { name: 'Korea Times', url: rss('https://www.koreatimes.co.kr/www/rss/biz.xml') },
    { name: 'Brasil de Fato', url: rss('https://www.brasildefato.com.br/feed/'), lang: 'pt' },
    { name: 'Slovenia Times', url: rss('https://sloveniatimes.com/feed/') },
  ...
  'supply-chain': [
    ...
    { name: 'InsideEVs', url: rss('https://insideevs.com/rss/news/all/') },
    { name: 'Electrive', url: rss('https://www.electrive.com/feed/') },
    { name: 'The Driven', url: rss('https://thedriven.io/feed/') },
    { name: 'Green Car Reports', url: rss('https://www.greencarreports.com/rss') },
    { name: 'Charged EVs', url: rss('https://chargedevs.com/feed/') },
    { name: 'Cinco Días', url: rss('https://cincodias.elpais.com/rss/cincodias/portada.xml'), lang: 'es' },
    { name: 'Expansión', url: rss('https://e00-expansion.uecdn.es/rss/portada.xml'), lang: 'es' },
    { name: 'Ambito Autos', url: rss('https://www.ambito.com/rss/pages/autos.xml'), lang: 'es' },
  ],
  leadership: [
  ...
  regulation: [
    ...
    { name: 'CLEPA', url: rss('https://clepa.eu/feed/') },
  ],
  frenchpress: [
    ...
    { name: 'Caradisiac', url: rss('https://www.caradisiac.com/rss.xml'), lang: 'fr' },
    { name: 'Turbo', url: rss('https://www.turbo.fr/actualites.xml'), lang: 'fr' },
    { name: 'Motor1 FR', url: rss('https://fr.motor1.com/rss/news/all/'), lang: 'fr' },
    { name: 'InsideEVs FR', url: rss('https://fr.insideevs.com/rss/news/all/'), lang: 'fr' },
    { name: 'Motor.es', url: rss('https://www.motor.es/feed/'), lang: 'es' },
    { name: 'Clarin Autos', url: rss('https://www.clarin.com/rss/autos/'), lang: 'es' },
  ],
};
...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  ...
  alerts: [
    'Reuters Business', 'AFP', 'Les Echos Renault', 'Challenges Renault', 'Capital Renault', 
    'Automotive News Europe', 'Automotive News', 'Autocar', 'Motor1', 'WardsAuto', 'Seeking Alpha Renault',
    'Le Monde', 'BFM Business'
  ],
  operations: [
    "L'Usine Nouvelle (Proxy)", 'Just Auto', 'Romania Insider', 'Economica.net', 'Daily Sabah', 
    'Hurriyet Daily News', 'Le360', 'TelQuel', 'Morocco World News', 'Korea Herald', 'Korea Times', 
    'Brasil de Fato', 'Slovenia Times'
  ],
  'supply-chain': [
    'Les Echos', 'InsideEVs', 'Electrive', 'The Driven', 'Green Car Reports', 'Charged EVs',
    'Cinco Días', 'Expansión', 'Ambito Autos', 'Google News Supply Chain'
  ],
  leadership: ['Google News CEO', 'Google News Executives', 'Les Echos Leadership', 'Challenges Leadership'],
  regulation: ['Google News Regulation', 'Google News EU Auto', 'CLEPA', 'Google News EU Competition'],
  frenchpress: [
    'Caradisiac', 'Turbo', 'Motor1 FR', 'InsideEVs FR', 'Le Figaro Auto', 'BFM Business Auto', 
    'Motor.es', 'Clarin Autos', 'Google News Industry FR'
  ],
};
