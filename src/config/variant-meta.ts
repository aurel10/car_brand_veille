...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  renault: {
    title: 'Renault Monitor - Crisis Intelligence Dashboard',
    description: 'Renault Group crisis intelligence dashboard for weak signals, supply-chain disruptions, labor unrest, regulatory issues, leadership risk, and brand reputation monitoring.',
    keywords: 'Renault monitoring, Renault crisis dashboard, Renault Group, Dacia, Alpine, Mobilize, Ampere, Horse, factory strikes, supply chain disruption, brand reputation, crisis intelligence, weak signals, automotive risk monitoring',
    url: 'https://renault.worldmonitor.app/',
    siteName: 'Renault Monitor',
    shortName: 'RenaultMonitor',
    subject: 'Renault Group Crisis Monitoring and Brand Intelligence',
    classification: 'Corporate Intelligence Dashboard, Crisis Monitoring Tool, Brand Risk Tracker',
    categories: ['business', 'news'],
    features: [
      'Weak-signal detection for Renault operations',
      'Boolean query management',
      'Entity-threat cross-reference matrix',
      'Factory and logistics map',
      'Mention trend tracking',
      'Thematic alert grouping',
      'French and global media monitoring',
      'GDELT BigQuery SQL generation',
    ],
  },
};
